...
<footer class="page-footer font-small stylish-color-dark pt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mx-auto">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="<?= base_url('Menu/index_menu'); ?>">Menu</a>
                    </li>
                    <li>
                        <a href="<?= base_url('Shop/index_shop'); ?>">Shop</a>
                    </li>
                    <li>
    ...
    <ul class="list-unstyled list-inline text-center">
        <li class="list-inline-item">
            <a class="btn-floating btn-fb mx-1" href="https://www.facebook.com/thefellowshipofkonakito/">
                <i class="fab fa-facebook-f"> </i>
            </a>
        </li>
        <li class="list-inline-item">
            <a class="btn-floating btn-tw mx-1" href="https://twitter.com/konakitoo?lang=en">
                <i class="fab fa-twitter"> </i>
            </a>
        </li>
        <li class="list-inline-item">
            <a class="btn-floating btn-instagram mx-1" href="https://www.instagram.com/konakito/?hl=en">
