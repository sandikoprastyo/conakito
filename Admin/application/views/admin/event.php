            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 centered">
                        ...
                        <?php endif; ?>
                        <a href="<?= base_url('event/tambahEvent'); ?>" type="button" class="btn btn-primary">Tambah Event</a>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($event as $ev) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $ev->deskripsi ?></td>
                                                <td><?= $ev->tanggal ?></td>
                                                <td><img src="<?= base_url('../assets/img/event/' . $ev->foto_event . ''); ?>" style="width:200px;height:100px;"></td>
                                                <td>
                                                    <?= anchor('event/editEvent/' . $ev->id_event, 'Edit',  ['class' => 'btn btn-primary']); ?>
                                                    <?= anchor('event/hapus/' . $ev->id_event, 'Hapus', ['onclick' => "return confirm('Anda Yakin ?')", 'class' => 'btn btn-danger']); ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
